...
\author{Daniel Foreman-Mackey\altaffilmark{\ref{affil:nyu},\ref{affil:queens}}
    \& Lawrence M. Widrow\altaffilmark{\ref{affil:queens}}}

\altaffiltext{1}{\label{affil:nyu}
...
\altaffiltext{2}{\label{affil:queens}Department of Physics, Engineering Physics, and Astronomy,
