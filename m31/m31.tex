...
\begin{equation}
    ...
    \pr_\sat (\data^{(i)} | \model) = \frac{1}{Z} \,
        \int \dd^6 \data \, S(\data^{(i)} | \data) \, \dfhalo (\E)
\end{equation}
where
\begin{equation}
    Z = \int \dd^6 \data \, \dfhalo (\E) = M_\mathrm{tot}
\end{equation}
and $S(\data_i | \data)$ is the distribution of the measured
...
\begin{equation}
    ...
    \pr_\sat (\data^{(i)} | \model)
        = \frac{2 \pi}{Z} \,
            ...
            \, \dfhalo (\E) \, g (D^{(i)}, \vlos^{(i)}, \vtan^{(i)}
                | D^\prime, \vlos^\prime, \vtan^\prime)
\end{equation}
where
\begin{equation}
...
\bibitem[Navarro et~al.(2010)]{Navarro:2010} Navarro, J.~F., Ludlow,
